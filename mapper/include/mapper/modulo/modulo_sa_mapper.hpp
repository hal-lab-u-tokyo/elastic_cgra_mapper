...
// Simulated annealing placement search using the same MRRG, operation
// compatibility, cost function, and route checker as YOTO/YOTT.
class ModuloSAMapper : public IMapper {
 public:
  ModuloSAMapper() = default;
  ModuloSAMapper(const std::shared_ptr<entity::DFG> dfg_ptr,
