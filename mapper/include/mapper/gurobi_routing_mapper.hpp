...
class GurobiILPRoutingMapper : public IILPMapper {
 public:
  GurobiILPRoutingMapper(){};
  GurobiILPRoutingMapper(const std::shared_ptr<entity::DFG> dfg_ptr,
                  const std::shared_ptr<entity::MRRG> mmrg_ptr);
  GurobiILPRoutingMapper* CreateMapper(const std::shared_ptr<entity::DFG> dfg_ptr,
                                const std::shared_ptr<entity::MRRG> mmrg_ptr);
