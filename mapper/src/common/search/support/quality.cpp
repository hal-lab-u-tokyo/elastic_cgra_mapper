...
double PlacementSearchEngine::ResourcePairPlacementCost(
...
double PlacementSearchEngine::EdgePlacementCost(
...
bool PlacementSearchEngine::PRISAEdgeIsWeak(int source_resource,
                                            int target_resource,
...
int PlacementSearchEngine::PRISAWeakEdgeCount(
