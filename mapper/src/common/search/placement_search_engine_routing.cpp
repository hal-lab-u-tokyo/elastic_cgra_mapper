...
std::optional<RouteUsage> PlacementSearchEngine::TryRoutePlacement(const PlacementState& state) {
...
std::optional<PathResult> PlacementSearchEngine::FindRoutePath(int source_dfg_node, int source_mrrg,
                                        int target_mrrg,
                                        const PlacementState& state,
...
int PlacementSearchEngine::ManhattanRouteScore(int from_mrrg_node, int to_mrrg_node) const {
...
std::optional<PathResult> PlacementSearchEngine::FindManhattanRoutePathNonEmptyAllowed(
    int source_dfg_node, int source_mrrg, int target_mrrg,
...
bool PlacementSearchEngine::CanUseNode(int mrrg_node_id, int source_dfg_node, int source_mrrg,
...
void PlacementSearchEngine::ReserveRoute(int source_dfg_node, int source_mrrg, int target_mrrg,
