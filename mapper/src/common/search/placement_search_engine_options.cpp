...
void PlacementSearchEngine::ResetSeed(int seed_index) { rng_.seed(SeedFor(seed_index)); }
...
entity::Mapping PlacementSearchEngine::MakePlacementOnlyMapping(const PlacementState& placement) const {
