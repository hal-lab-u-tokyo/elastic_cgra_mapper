...
## YOTO/YOTT Paper Comparison

- Paper-comparison configs: `research/configs/mapper/placement2d/paper_comparison/`.
...
- Run configs: `research/configs/experiments/placement2d/paper_comparison/traversal_yott.json`.
