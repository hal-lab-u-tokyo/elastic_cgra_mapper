...
double Placement2DArrayEngine::PlacementCost(
...
PlacementQuality Placement2DArrayEngine::ComputePlacementQuality(
    const PlacementState& state) const {
...
bool Placement2DArrayEngine::IsBetterQuality(
    const PlacementQuality& candidate, const PlacementQuality& best) const {
...
int Placement2DArrayEngine::PRISAWeakEdgeCount(
    const PlacementState& state) const {
  int result = 0;
...
double Placement2DArrayEngine::CostAwarePRISAScore(
    const PlacementState& state) const {
...
double Placement2DArrayEngine::PRISAAcceptanceScore(
    const PlacementState& state) const {
...
std::vector<int> Placement2DArrayEngine::CompatibleCells(
...
void Placement2DArrayEngine::PlaceNode(int dfg_node, int cell,
