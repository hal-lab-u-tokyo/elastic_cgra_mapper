...
int Placement2DArrayEngine::PRISAResourceSideLength() const { return std::max(rows_, cols_); }
...
int Placement2DArrayEngine::Cell(int row, int col) const { return row * cols_ + col; }
...
bool Placement2DArrayEngine::CanPlace(int dfg_node, int cell, const PlacementState& state) const {
...
bool Placement2DArrayEngine::IsCPUMappingCompatible(int dfg_node, int cell) const {
...
bool Placement2DArrayEngine::CanPlaceCPUMapping(int dfg_node, int cell,
