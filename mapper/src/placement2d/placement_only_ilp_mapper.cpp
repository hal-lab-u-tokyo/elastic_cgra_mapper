...
namespace {
const bool kPlacementOnlyILPMapperRegistered =
    mapper::RegisterMapperType<mapper::PlacementOnlyILPMapper>(
        "PlacementOnlyILPMapper");
const bool kLegacyILPPlacementMapperRegistered =
    mapper::RegisterMapperType<mapper::PlacementOnlyILPMapper>(
        "ILPPlacementMapper");
const bool kLegacyPlacementILPMapperRegistered =
    mapper::RegisterMapperType<mapper::PlacementOnlyILPMapper>(
        "PlacementILPMapper");
const bool kLegacyGurobiPlacementILPMapperRegistered =
    mapper::RegisterMapperType<mapper::PlacementOnlyILPMapper>(
        "GurobiPlacementILPMapper");
}

mapper::PlacementOnlyILPMapper::PlacementOnlyILPMapper(
    const std::shared_ptr<entity::DFG> dfg_ptr,
    const std::shared_ptr<entity::MRRG> mrrg_ptr)
    : dfg_ptr_(dfg_ptr), mrrg_ptr_(mrrg_ptr) {}

mapper::PlacementOnlyILPMapper*
mapper::PlacementOnlyILPMapper::CreateMapper(
    const std::shared_ptr<entity::DFG> dfg_ptr,
    const std::shared_ptr<entity::MRRG> mrrg_ptr) {
  mapper::PlacementOnlyILPMapper* result =
      new mapper::PlacementOnlyILPMapper;
  *result = mapper::PlacementOnlyILPMapper(dfg_ptr, mrrg_ptr);

  return result;
}

mapper::MappingResult mapper::PlacementOnlyILPMapper::Execution() {
...
void mapper::PlacementOnlyILPMapper::SetLogFilePath(
    const std::string& log_file_path) {
  log_file_path_ = log_file_path;
  return;
}

void mapper::PlacementOnlyILPMapper::SetTimeOut(double timeout_s) {
  timeout_s_ = timeout_s;
  return;
}

void mapper::PlacementOnlyILPMapper::SetAcceptFeasibleSolution(
