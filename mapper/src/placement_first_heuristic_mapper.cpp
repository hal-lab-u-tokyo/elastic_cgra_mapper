...
mapper::PlacementFirstHeuristicMapper::PlacementFirstHeuristicMapper(
    const std::shared_ptr<entity::DFG> dfg_ptr,
    const std::shared_ptr<entity::MRRG> mrrg_ptr)
    : dfg_ptr_(dfg_ptr), mrrg_ptr_(mrrg_ptr) {}

mapper::PlacementFirstHeuristicMapper*
mapper::PlacementFirstHeuristicMapper::CreateMapper(
    const std::shared_ptr<entity::DFG> dfg_ptr,
    const std::shared_ptr<entity::MRRG> mrrg_ptr) {
  auto* result = new mapper::PlacementFirstHeuristicMapper;
  *result = mapper::PlacementFirstHeuristicMapper(dfg_ptr, mrrg_ptr);
  return result;
}

mapper::MappingResult mapper::PlacementFirstHeuristicMapper::Execution() {
...
void mapper::PlacementFirstHeuristicMapper::SetLogFilePath(
    const std::string& log_file_path) {
  log_file_path_ = log_file_path;
}

void mapper::PlacementFirstHeuristicMapper::SetTimeOut(double timeout_s) {
  timeout_s_ = timeout_s;
}

void mapper::PlacementFirstHeuristicMapper::SetAcceptFeasibleSolution(
