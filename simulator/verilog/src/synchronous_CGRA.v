...
module CGRA (
    ...
    // DEBUG
    output DEBUG_valid_output[PE_ROW_SIZE][PE_COLUMN_SIZE],
    output [CONTEXT_SIZE_BIT_LENGTH-1:0] DEBUG_alu_context_id[PE_ROW_SIZE][PE_COLUMN_SIZE],
    output [CONTEXT_SIZE_BIT_LENGTH-1:0] DEBUG_output_context_id[PE_ROW_SIZE][PE_COLUMN_SIZE],
        ...
        for (i = 0; i < PE_ROW_SIZE; i++) begin : GenerateProcessingElementI
            for (
                ...
                PE pe (
                    ...
                    .DEBUG_valid_output(DEBUG_valid_output[i][j]),
                    ...
                    .DEBUG_output_context_id(DEBUG_output_context_id[i][j])
                );
            end
        end
    endgenerate
