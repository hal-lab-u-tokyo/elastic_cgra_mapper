...
if __name__ == "__main__":
  ...
  remapping_writer.writerow(["log_file_path", "date", "time", "row", "column", "context_size", "memory_io", "cgra_type", "network_type", "local_reg_size", "parallel_num", "mapping_type_num","remapper_mode", "remapper_time", "mapping_json_list", "db_num"])
