    ...
    with open(log_file_path) as f:
        ...
        for line in f:
            ...
            if line_num == mapping_file_num + 8:
                ...
                remapper_log_info.parallel_num = min(parallel_num, parallel_num_from_exec) # some log file has upper limit of parallel num instead of the result of remapping
