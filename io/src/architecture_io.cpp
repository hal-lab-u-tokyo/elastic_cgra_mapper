...
entity::MRRG io::ReadMRRGFromJsonFile(std::string file_name) {
  ...
  auto is_TM_raccoon_2_data =
      ptree.get<std::string>("is_TM_raccoon_2", "false");
  ...
  mrrg_config.loop_pe_pos =
      entity::MRRGLoopPEPositionFromString(loop_pe_pos_data);
  ...
  std::cout << "network_type: "
            << entity::MRRGNetworkTypeToString(mrrg_config.network_type)
            << std::endl;
  std::cout << "is_raccoon: " << mrrg_config.is_raccoon << std::endl;
  std::cout << "loop_pe_pos: "
            << entity::MRRGLoopPEPositionToString(mrrg_config.loop_pe_pos)
            << std::endl;
  std::cout << "tm_pe_pos: "
            << entity::MRRGTMPEPositionToString(mrrg_config.tm_pe_pos)
            << std::endl;
