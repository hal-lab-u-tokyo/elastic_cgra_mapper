...
| TRAVERSAL/YOTT reproduction | `configs/experiments/placement2d/reproduction/traversal_yott.json` |
| YOTT 2021 benchmark reproduction | `configs/experiments/placement2d/reproduction/yott_cases2021.json` |
| PRISA reproduction | `configs/experiments/placement2d/reproduction/prisa_vpr8.json` |
...
| `docs/` | metric definitions, reproduction notes, and extension guides |
